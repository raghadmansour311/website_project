document.addEventListener("DOMContentLoaded", () => {
    ...
    if (navbarContainer) {
        ...
        <nav class="navbar">
            ...
            <ul class="nav-links">
                ...
                <li class="dropdown">
                    <a href="#">
                        Perfumes <i class="fa-solid fa-chevron-down"></i>
                    </a>
                    <ul class="dropdown-menu">
                        <li><a href="all-perfumes.html">All Perfumes</a></li>
                        <li><a href="women.html">Women</a></li>
                        <li><a href="men.html">Men</a></li>
                        <li><a href="unisex.html">Unisex</a></li>
                    </ul>
                </li>
                <li><a href="limited.html">Limited Edition</a></li>
    ...
    // 2. حقن الفوتر المحدث (تمت إزالة كلمة AROME ونقل وتعديل رابط الفريق للمنتصف)
        ...
        <footer class="footer">
            <div class="footer-container">
                ...
                <div class="footer-contact">
                    ...
                    <a href="mailto:info@arome.com">info@arome.com</a>
                    <p>+970 59 XXX XXXX</p>
                </div>
            </div>
            <hr>
